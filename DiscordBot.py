...
async def comandi(ctx):
    ...
    embed.add_field(name="» ***𝐒𝐭𝐚𝐟𝐟*** :sparkles:", value="**|** ` ^info ` **|** ` ^crea ` **|** ` ^serverinfo ` **|**", inline=True)
...
async def membri(ctx):
    ...
    embed.add_field(name="♕ Vx Shax", value="** **", inline=True)
    embed.add_field(name="♕ Vx Distance", value="** **", inline=True)
    embed.add_field(name="♕ Vx SickAndreh", value="** **", inline=True)
    embed.add_field(name="♕ Vx Atomic.-", value="** **", inline=True)
    embed.add_field(name="♕ Vx Francesco", value="** **", inline=True)
